...
const {createEntries} = require("../bin/seeds")
...
module.exports.login = async (req, res, next) => {
  try {
	...
	createEntries('66487de9e538db030ee1e6ad', false)
      .catch(error => console.error('Error generating calendar entries during login:', error));
